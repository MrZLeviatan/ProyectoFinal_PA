    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.DELETE,"/api/categoria").hasAnyAuthority("ROL_MODERADOR")
                        .requestMatchers(HttpMethod.POST,"/api/categoria").hasAuthority("ROL_MODERADOR")
                        .requestMatchers(HttpMethod.PUT,"/api/categoria").hasAuthority("ROL_MODERADOR")
