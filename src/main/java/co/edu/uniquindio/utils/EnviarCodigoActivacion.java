...
public class EnviarCodigoActivacion implements Notificación {


    private String asunto,destinatario,mensaje;
    private String username,password;

    public EnviarCodigoActivacion(String asunto, String destinatario, String mensaje) {
        this.asunto = asunto;
...
// Se definen las credenciales de la cuenta de correo
       ...
       this.password = "sfkhuwecmnohyvwg";
